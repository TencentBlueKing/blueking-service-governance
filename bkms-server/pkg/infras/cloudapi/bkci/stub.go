...
func (s *StubApiClient) CreateRepository(
	...
	log.Infof(ctx, "Stub: CreateRepository request: %s, %s, %s, %s", projectCode, opts.URL, opts.Alias, opts.RepoType)
	repoID := stubRepositoryID(projectCode, opts.URL, opts.Alias)
