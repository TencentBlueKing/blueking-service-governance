...
- **技术栈**：Go（Gin REST，bkms-server/bkms-cli/bkms-dockerfile-generator/libs/bkms-adapter）+ Vue 3 + TypeScript + Vite（bkms-ui）
- **Agent 适用场景**：REST API / CLI 子命令 / 前端页面组件开发、部署流程与镶嵌规范维护、知识图谱驱动的代码探索
