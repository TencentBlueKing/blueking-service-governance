...
When --env is provided, this command views the effective lifecycle config for that environment.`,
		Example: `  # View default lifecycle config
  bkms-cli app appspec lifecycle view --app my-app

  # View effective lifecycle config for an environment
